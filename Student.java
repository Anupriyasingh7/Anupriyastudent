...
public class Student {
        public static void main(String[] args) {
                ...
                s11.get(1,"Anupriya",19321,61,78, 91);
                s21.get(1,"Shailvi",322, 77,91,65);
                s31.get(1,"Jaishree", 19323, 85, 65,87);

                s12.get(2,"Anupriya",19321,68,74, 96);
                s22.get(2,"Shailvi", 19322, 67,81,75);
                s32.get(2,"Jaishree", 19323, 75, 95,77);
